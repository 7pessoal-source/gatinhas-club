          ...
          <div className="prose prose-pink prose-lg max-w-none space-y-6 text-muted-foreground leading-relaxed">
            {post.id === "o-que-fazer-em-macapa-a-noite" ? (
              <>
                ...
                <p>
                  O <Link to="/acompanhantes/centro-macapa" className="text-primary hover:underline font-semibold">Centro de Macapá</Link> concentra 
                ...
                <p>
                  A <Link to="/acompanhantes-zona-norte-macapa" className="text-primary hover:underline font-semibold">Zona Norte</Link> tem crescido 
                ...
                <div className="my-10 rounded-2xl gradient-primary p-8 text-primary-foreground shadow-glow">
                  ...
                  <Link to="/" className="inline-block rounded-xl bg-white px-6 py-3 font-bold text-primary transition-all hover:scale-105">
              ...
              <>
                ...
                <p>
                  Se você busca discrição total, bairros como o <Link to="/acompanhantes/trem-macapa" className="text-primary hover:underline font-semibold">Trem</Link> e 
                  <Link to="/acompanhantes/santa-rita-macapa" className="text-primary hover:underline font-semibold"> Santa Rita</Link> são excelentes opções por serem 
                ...
                <div className="my-10 rounded-2xl border border-border bg-card p-8 shadow-sm">
                  ...
                  <Link to="/acompanhantes-macapa" className="inline-block rounded-xl gradient-primary px-6 py-3 font-bold text-primary-foreground transition-all hover:shadow-glow">
